...
const httpClient = supertest('https://coderhouse-proyecto-final-production.up.railway.app');
...
describe('api rest', () => {
  ...
  describe('POST /api/carts/:cid/product/:pid', () => {
    describe('when sending a request to add a product to a cart', () => {
      it.skip('adds the product to the cart and returns status code 201', async () => { // TODO: revisar
